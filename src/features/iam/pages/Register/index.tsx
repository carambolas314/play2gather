const Register = () => {
	return  <div className="min-h-screen bg-[#1C1C2E] flex items-center justify-center font-jost">
      ...
      <div className="bg-[#2B2156] mt-16 mb-32 p-8 md:p-10 rounded-2xl shadow-2xl w-full max-w-md mx-auto">
        ...
        <div className="flex items-center mb-6 flex-colunm">
          <div className="w-1/2 h-2 bg-gray-600 rounded-full justify-self-center">
            <div className="w-1/3 h-full bg-[#CBE220] rounded-full"></div> {/* Exemplo de progresso 1/3 */}
          </div>
          <button className="text-white text-3xl justify-self-start">
        ...
        <div className="flex justify-center gap-4">
          ...
          <button className="bg-white rounded-full p-3 flex items-center justify-center shadow-lg hover:scale-105 transition duration-200">
            <img src="https://img.icons8.com/ios-filled/50/000000/twitterx--v1.png" alt="Twitter X" className="h-6 w-6"/>
          </button>
        </div>
      </div>
    </div>;
